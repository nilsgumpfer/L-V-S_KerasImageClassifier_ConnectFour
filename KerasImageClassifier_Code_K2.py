...
with open('KerasImageClassifier_Model_K2.json', 'w') as model_file:
...
# model.load_weights('KerasImageClassifier_Weights_K2.h5')
...
model.save_weights('KerasImageClassifier_Weights_K2.h5')
